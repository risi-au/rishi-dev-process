...
2. **Read the core (required):**
   ...
   - `core/GRAPH-TOOLS.md` — query the index before you Grep. Three tools, different jobs:
     **CodeGraph** for structural questions (who calls this, what breaks, is it tested),
     **Serena** for editing a symbol, **graphify** for conceptual ones (how does this area work).
     Catching yourself about to Grep the codebase is the signal that you skipped this.
